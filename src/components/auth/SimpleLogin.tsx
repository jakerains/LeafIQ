...
import { Lock, Mail, Eye, EyeOff, Coffee, ArrowLeft } from 'lucide-react';
          ...
          <div className="bg-white bg-opacity-90 backdrop-blur-md rounded-3xl p-8 shadow-xl max-w-md w-full relative">
            ...
            >
              ...
              <button
                ...
                className="w-full py-3 border border-primary-200 text-primary-700 hover:bg-primary-50 rounded-xl font-medium transition-all duration-200 flex items-center justify-center"
              >
