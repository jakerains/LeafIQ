    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-300 focus:border-green-300 transition-all"
            />
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <h3 className="text-lg font-semibold">Common Cannabis Terpenes</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {filteredTerpenes.map((terpene) => (
              <motion.div
                ...
                className={`
                  p-4 bg-white bg-opacity-80 backdrop-blur-sm rounded-2xl border-2 cursor-pointer
              ...
              >
                <div className="flex items-center space-x-3 mb-3">
                  <div className={`p-2 ${terpene.color} text-white rounded-xl`}>
                    {terpene.icon}
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900">{terpene.name}</h4>
                    <p className="text-sm text-gray-600">{terpene.percentage}</p>
                  </div>
                </div>
                
                <p className="text-sm text-gray-700 mb-3">{terpene.description}</p>
        ...
        <div className="space-y-4">
          ...
          >
            <div className="flex items-center space-x-3 mb-4">
              <div className={`p-3 ${selectedTerpene.color} text-white rounded-xl`}>
            ...
            <p className="text-gray-700 mb-4">{selectedTerpene.description}</p>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-4 border border-blue-200">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <h4 className="font-medium text-blue-900">Employee Tip</h4>
            </div>
