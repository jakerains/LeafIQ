    ...
    <div className="flex flex-col items-center w-full max-w-4xl mx-auto space-y-8">
      ...
      <div className="w-full">
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl shadow-xl border border-green-200 overflow-hidden max-w-5xl mx-auto">
          <div className="overflow-y-auto p-6 space-y-4 bg-white bg-opacity-70">
          ...
          <div className="p-4 bg-white bg-opacity-90 border-t border-gray-100">
            {showSuggestions && (
              <div className="mb-4">
            ...
            <form onSubmit={handleSendMessage} className="flex items-end gap-2">
              <div className="relative flex-1">
                <textarea
                  ...
                  className="w-full p-4 pr-12 border border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 rounded-xl resize-none min-h-[60px] max-h-[200px] bg-white"
                  rows={1}
                  disabled={isLoading}
                />
                <button
