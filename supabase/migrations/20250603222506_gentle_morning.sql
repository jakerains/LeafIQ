/*
  # Add super_admin role and Pinecone document storage
  
  1. Schema Updates
    - Add 'super_admin' to the allowed roles in profiles table
    - Create view for super_admin users
    - Add is_super_admin() function
  
  2. Security
    - Add RLS policy for super_admin access to profiles
    - Create pinecone_documents table with RLS policies
*/
